...
export class ClienteController {
  ...
  async create(
    ...
    let contenido = `Hola ${cliente.nombreUsuario}, su nombre de usuario es: ${cliente.email} y su contraseña es: ${cliente.password}`;
    let notificadoEmail= this.servicioNotificacion.notificacionEmail(destino,asunto,contenido)
    if(notificadoEmail){
      return p;
    } else{
      new HttpErrors[500]("error no se pudo notificar al usuario")
    } 
  }
