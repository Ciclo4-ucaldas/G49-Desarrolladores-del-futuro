...
export class PedidoProductoController {
  ...
  async find(
    ...
    return this.pedidoRepository.susProductos(id).find(filter);
  }
  ...
  async create(
    ...
    return this.pedidoRepository.susProductos(id).create(producto);
  }
  ...
  async patch(
    ...
    return this.pedidoRepository.susProductos(id).patch(producto, where);
  }
  ...
  async delete(
    ...
    return this.pedidoRepository.susProductos(id).delete(where);
  }
}
